...
class PostgresListen extends Activity {
    constructor(opts) {
        super(opts);
        this.paramsValidator = Validator.compile({
            ...
            properties: {
                ...
                topic: {
                    type: 'string', description: 'The topic to listen to'
                }
            }
        });
    }
    ...
    run(input, context, callback) {
        ...
        db.listen(this.params.topic).then((result) => {
